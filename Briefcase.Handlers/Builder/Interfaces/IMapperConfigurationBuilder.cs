...
namespace Briefcase.Handlers.Builder.Interfaces
{
    ...
    public interface IMapperConfigurationBuilder<T, TRequest> : IMapperConfigurationBuilder
    {
        ...
        /// <returns></returns>
        IMapperConfigurationBuilder<T, TRequest> For<TProp>(Expression<Func<T, TProp>> expression, Func<IPropertyMapperBuilder<T, TRequest, TProp>, bool> configurationMethod);
